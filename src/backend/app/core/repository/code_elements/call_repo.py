...
class CallRepo():
    ...
    def create(self, call, parent_id: str, target_id: str):
        pass

    def find_call_by_target_parent(self, target_id: str, parent_id: str):
        pass

    def get_call_by_id(self, call_id: str):
        pass

    def get_children(self, call_id: str, child_type: str):
        pass
