...
class ClassRepo(BaseRepo[ClassNode, ClassSchema]):
    ...
    async def create(self, class_node: Union[ClassNode, List[ClassNode]], project_db_name: str, raw: bool = False):
    ...
    async def update_batch(self, classes: List[ClassNode], project_db_name: str):
    ...
    async def get_by_id(self, class_id: str, project_db_name: str, raw: bool = False):
        return await super().get_by_id(class_id, project_db_name, raw)
