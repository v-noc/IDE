...
class GroupService(ContainerService):
    ...
    def add_child_to_group(self, group_id: str, child_id: str):
        ...
        self.remove_child_from_group(parent.id, child_id)
    ...
    def delete(self, group_id: str, remove_children: bool = False):
        ...
        if remove_children:
            for child in children:
                self.remove_child_from_group(group_id, child.id)

        return self.repos.group_repo.delete(group_id)
    ...
    def create(
        ...
        for child in children:
            ...
            self.remove_child_from_group(parent.id, child.id)
