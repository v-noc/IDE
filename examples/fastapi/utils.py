...
def is_body_allowed_for_status_code(status_code: Union[int, str, None]) -> bool:
    """ID: a75b9898-a8ed-4ed8-af79-27bdc420ddfa"""
...
def get_path_param_names(path: str) -> Set[str]:
    """ID: b0048375-7878-4ca4-8ef9-8dd9de865fa0"""
...
def create_model_field(
    ...
    """ID: 438dc4e1-ce0b-4b41-97bc-dbe7d6ccb042"""
...
def create_cloned_field(
    ...
    *,
    ...
    """ID: 78ba9b92-eefe-4daf-b40d-68c666596ee7"""
    if PYDANTIC_V2:
        from ._compat import v2
...
def generate_operation_id_for_path(
    *, name: str, path: str, method: str
    ...
    """ID: c03b56ba-1b76-4483-9c3d-ec799d348bf7"""
    warnings.warn(
...
def generate_unique_id(route: "APIRoute") -> str:
    """ID: 5425484a-3b41-4e64-b038-a5190d565033"""
...
def deep_dict_update(main_dict: Dict[Any, Any], update_dict: Dict[Any, Any]) -> None:
    """ID: a201bdfe-d4f0-4151-b803-252f8b474e2f"""
...
ID: 197fa614-de8b-4b0b-bead-5a9db8d0ae1c"""
