...
def ensure_multipart_is_installed() -> None:
    """ID: a91b8648-84a0-4fa1-b923-a8735262dc70"""
    try:
...
def get_param_sub_dependant(
    *,
    ...
    """ID: 6c4cddba-7038-4850-82b2-5204b060f611"""
...
def get_parameterless_sub_dependant(*, depends: params.Depends, path: str) -> Dependant:
    """ID: 47c1305b-45fd-485e-b70c-c9b3af8b8bbc"""
...
def get_sub_dependant(
    *,
    ...
    """ID: e93d105c-afc3-4660-a370-0389beb57104"""
...
def get_flat_dependant(
    ...
    *,
    ...
    """ID: 2be49f38-495e-4357-911e-eb06637ff0b8"""
    if visited is None:
        visited = []
...
def _get_flat_fields_from_params(fields: List[ModelField]) -> List[ModelField]:
    """ID: 5b5ba25a-535b-4c30-b0a7-709f6465db2a"""
    if not fields:
        return fields
...
def get_flat_params(dependant: Dependant) -> List[ModelField]:
    """ID: 172c374c-9c57-4bea-8a81-df06863a088d"""
...
def get_typed_signature(call: Callable[..., Any]) -> inspect.Signature:
    """ID: 8b643088-f645-4294-abfd-cc23f95da1dd"""
...
def get_typed_annotation(annotation: Any, globalns: Dict[str, Any]) -> Any:
    """ID: e0efff71-9e99-493d-aebb-f48149d2f538"""
...
def get_typed_return_annotation(call: Callable[..., Any]) -> Any:
    """ID: e00e82ae-d215-4c9b-b7ba-2d8cdcdb189e"""
    signature = inspect.signature(call)
...
def get_dependant(
    *,
    ...
    """ID: 1ed929bb-5c5a-4fab-b6ad-407750fe67bd"""
...
def add_non_field_param_to_dependency(
    *, param_name: str, type_annotation: Any, dependant: Dependant
    ...
    """ID: 3fbbd58c-1ae9-403a-8e18-a21059348451"""
...
@dataclass
class ParamDetails:
    """ID: 5533783d-8c35-4424-887a-f016bcea0e4c"""
    type_annotation: Any
...
def analyze_param(
    *,
    ...
    """ID: 18c3c32d-35c5-40ba-afca-bed74e5345c3"""
    field_info = None
    depends = None
...
def add_param_to_fields(*, field: ModelField, dependant: Dependant) -> None:
    """ID: 34eb4a8c-abb3-467e-a804-97a960649129"""
...
def is_coroutine_callable(call: Callable[..., Any]) -> bool:
    """ID: dd24bc76-5e02-4848-aabc-945b79545b1f"""
...
def is_async_gen_callable(call: Callable[..., Any]) -> bool:
    """ID: f938b97f-d444-4b67-991c-91791f19782f"""
...
def is_gen_callable(call: Callable[..., Any]) -> bool:
    """ID: 6fc0ae8b-c3da-475c-8560-c2ad68401d90"""
...
async def solve_generator(
    *, call: Callable[..., Any], stack: AsyncExitStack, sub_values: Dict[str, Any]
    ...
    """ID: d6de3b59-1912-47b5-8e7b-621aba51da4f"""
...
class SolvedDependency:
    """ID: 213012ec-4a19-47c3-ae12-b93c34998067"""
    values: Dict[str, Any]
    errors: List[Any]
...
async def solve_dependencies(
    *,
    ...
    """ID: 3305101b-e837-4d33-8c2e-6b1636b6027b"""
    values: Dict[str, Any] = {}
    errors: List[Any] = []
    if response is None:
        response = Response()
...
def _validate_value_with_model_field(
    *, field: ModelField, value: Any, values: Dict[str, Any], loc: Tuple[str, ...]
    ...
    """ID: ac47cbf0-6835-4455-b079-0c11aa997bfd"""
    if value is None:
        if field.required:
...
def _get_multidict_value(
    ...
    """ID: 28947a6e-8a6b-478f-b365-d8dbaa890e94"""
...
def request_params_to_args(
    ...
    """ID: c0ec5ad4-6444-42c1-85ce-9acce8678293"""
    values: Dict[str, Any] = {}
...
ID: 1e8d9d77-0d3a-4cb2-864b-6a3d67478414"""
...
def _should_embed_body_fields(fields: List[ModelField]) -> bool:
    """ID: 2e726859-3add-42a6-9974-b4d4192064a8"""
    if not fields:
        return False
...
async def _extract_form_body(
    ...
    """ID: 45fe6764-938e-4083-9435-baba3365ad82"""
    values = {}
    ...
    for field in body_fields:
        ...
        if (
            ...
            async def process_fn(
                ...
                """ID: f5a6192b-fd70-472b-9a9d-345df29da1bc"""
                result = await fn()
...
async def request_body_to_args(
    ...
    """ID: 51ff4770-4e20-4121-9fc9-9ccd74bfc607"""
    values: Dict[str, Any] = {}
    errors: List[Dict[str, Any]] = []
...
ID: 387cfd56-137e-4ecc-be61-99d7cae1132b"""
